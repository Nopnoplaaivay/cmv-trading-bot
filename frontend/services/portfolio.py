# # frontend/services/portfolio_service.py
# """
# Portfolio management service for custom portfolios
# """
...
#     @staticmethod
#     def create_custom_portfolio(name: str, symbols: List[str], 
#                               description: str = "", max_positions: int = 20) -> Dict:
#         """Create a new custom portfolio"""
#         try:
#             response = requests.post(
#                 f"{API_BASE_URL}/portfolio-service/portfolios/custom",
#                 json={
#                     "name": name,
#                     "symbols": symbols,
...
#                 f"{API_BASE_URL}/portfolio-service/portfolios/my",
#                 headers=get_auth_headers(),
#                 timeout=30,
#             )
...
#         try:
#             response = requests.get(
#                 f"{API_BASE_URL}/portfolio-service/portfolios/{portfolio_id}/analysis",
